...
- Device garage using IndexedDB: saved builds, price notes, automatic draft recovery, comparison, undo, search, sort and fitment-status filters. Backups are important; app/browser storage and OS backups are not a guaranteed archival service.
