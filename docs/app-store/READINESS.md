...
- Native share sheet for build links, current and saved-build shop briefs, current and saved-build parts CSV and JSON backups; temporary exported files are removed from the app cache after sharing returns.
