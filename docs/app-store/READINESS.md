...
- Native share sheet for build links, shop briefs, parts CSV and JSON backups; temporary exported files are removed from the app cache after sharing returns.
