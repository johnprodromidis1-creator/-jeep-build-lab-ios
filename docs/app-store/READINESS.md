...
Status: source prepared for an initial iOS device build. Not submitted to App Store Connect or TestFlight. No signed IPA exists yet. Native compilation and physical-device tests remain required.
